...
export const AIR_FRYERS: Product[] = [
  {
    ...
    details: {
      tagline:
        "The pick we point most small-kitchen renters at: a genuinely compact footprint and one of the lowest running costs here.",
      overview: [
        ...
        "Running cost works out at roughly €0.19 for a 20-minute cook on current Irish electricity prices — among the cheapest in this guide.",
      ],
      pros: [
  ...
  },
  {
    ...
    details: {
      tagline:
        "The most capacity for the space here: a 6.2 L drawer in a low-profile body, if you can spare the worktop depth.",
      overview: [
        "The NA230/09 pairs a large 6.2 L drawer with a compact, low-profile body, which is why it earns the value badge — you get family-sized capacity without a family-sized appliance taking over the worktop.",
      ...
      bestFor:
        "Sharers and small households who want batch capacity without giving up much worktop, with depth to spare.",
    },
  },
  {
    id: "tefal-ey245840",
