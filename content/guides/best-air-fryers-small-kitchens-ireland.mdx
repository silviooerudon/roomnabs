...
1. Wire each "Check price" CTA through /go/[linkId]. Suggested linkIds:
   af100uk-hn, af180uk-currys, crispi-fn101-euronics, morphy-480005-currys, philips-na230-amazon, tefal-eyf-amazon
...
<ComparisonTable caption="Quick picks: compact air fryers compared">
...
<ProductCard
  ...
  tagline="best overall for a small kitchen"
  badge="Overall, 1–2 people"
  linkId="af100uk-hn"
  specs={[
    { label: "Footprint", value: "952 cm²" },
    { label: "Height", value: "35 cm" },
  ...
  goodFor="one or two people who want a simple, well-priced first air fryer."
  notFor="anyone batch-cooking for three or four — 3.8 L gets tight."
  note="Stocked at Harvey Norman IE, Euronics IE, Ninja IE, Very IE."
>
...
<ProductCard
  ...
  tagline="cheapest to run, best for one"
  badge="Cheapest to run, solo"
  linkId="morphy-480005-currys"
  specs={[
    { label: "Footprint", value: "940.2 cm²" },
    { label: "Height", value: "31.3 cm" },
  ...
  goodFor="solo cooking, and the lowest energy use per cook."
  notFor="more than one person regularly."
  note="Sourcing note: power figure is from a retailer (the manufacturer omits it) and the price needs confirming before publish."
>
...
<ProductCard
  ...
  goodFor="a narrow worktop with open space above."
  notFor="squeezing under a low shelf or cabinet."
  note="Sourcing note: Tefal's smaller 3.5–4.2 L singles left the Irish catalogue, so this 5 L is the current compact-ish option; price needs confirming."
>
...
<ProductCard
  ...
  tagline="best for batch cooking / shared houses"
  badge="Batch / shared house"
  linkId="af180uk-currys"
  specs={[
    { label: "Footprint", value: "1008 cm²" },
    { label: "Height", value: "30.5 cm" },
  ...
  goodFor="batch cooking and shared houses, without a dual drawer's bulk."
  notFor="a one-person kitchen watching energy use."
  note="Sourcing note: Ninja lists 2470 W; Currys lists 2000 W — we used the manufacturer figure."
>
...
<ProductCard
  name="Philips 2000 Series (NA230/09) 6.2L"
  tagline="best value if you have a bit more worktop"
  badge="Best value, bigger"
  linkId="philips-na230-amazon"
  specs={[
    { label: "Footprint", value: "1248.4 cm² (largest, mostly from 40.4 cm depth)" },
    { label: "Height", value: "30.8 cm" },
    { label: "Fits under ~45 cm cabinet", value: "yes" },
  ...
  goodFor="more capacity for the money, if depth isn't a problem."
  notFor="a shallow worktop."
  note="Sourcing note: the Irish model is NA230/09 (not /00); dimensions came from a spec mirror and should be confirmed on Philips directly."
>
...
<ProductCard
  name="Ninja CRISPi 4-in-1 Portable Glass (FN101UKGY)"
  tagline="premium and versatile"
  badge="Premium / versatile"
  linkId="crispi-fn101-euronics"
  specs={[
    { label: "Footprint", value: "1033.6 cm²" },
    { label: "Height", value: "34.5 cm" },
    { label: "Fits under ~45 cm cabinet", value: "yes" },
    { label: "Power", value: "1700 W" },
    { value: "~€0.21 per 20-min cook" },
  ...
  goodFor="someone who wants one device for cooking, storing and reheating."
  notFor="a tight budget, or anyone who just wants a simple basket."
  note="Sourcing note: don't confuse it with the larger CRISPi PRO 7-in-1 (AS101UK)."
>
