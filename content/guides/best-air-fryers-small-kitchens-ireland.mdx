...
One thing worth checking before you spend anything: ours actually came with the house we moved into — which turns out to be really common here. A lot of Irish rentals already have one, so check before you buy.
...
[Check price →](/go/morphy-480005-currys)
